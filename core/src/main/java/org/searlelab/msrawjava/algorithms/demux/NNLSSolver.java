...
public class NNLSSolver {
	 ...
	 *
	 * @param maxIterations maximum iterations for the active set algorithm
	 */
	 ...
	 *
	 * @param A the design matrix (m × n)
	 * @param b the observation vector (m × 1)
	 ...
	 *
	 * @param A the design matrix (m × n)
	 * @param B the observation matrix (m × p), each column is a separate problem
