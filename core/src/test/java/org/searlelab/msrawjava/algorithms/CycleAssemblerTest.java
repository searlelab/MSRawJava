...
class CycleAssemblerTest {
	...
	void setUp() {
		...
		windows = Arrays.asList(
			new Range(400.0, 500.0),
			new Range(500.0, 600.0),
			new Range(600.0, 700.0)
		);
	...
	private FragmentScan createScan(Range window, int index) {
		...
		return new FragmentScan(
			...
			"precursor",
			index,
			(window.getStart() + window.getStop()) / 2,
			index * 1.0f,  // scanStartTime
			0,
			null,
			window.getStart(),
			window.getStop(),
	...
	void flushPartialRejectsTooSmallCycle() {
		...
		List<Range> sixWindows = Arrays.asList(
			new Range(400.0, 450.0),
			new Range(450.0, 500.0),
			new Range(500.0, 550.0),
			new Range(550.0, 600.0),
			new Range(600.0, 650.0),
			new Range(650.0, 700.0)
		);
	...
	void manyWindowsCycleRequiresHalf() {
		...
		List<Range> manyWindows = Arrays.asList(
			new Range(400.0, 450.0),
			new Range(450.0, 500.0),
			new Range(500.0, 550.0),
			new Range(550.0, 600.0),
