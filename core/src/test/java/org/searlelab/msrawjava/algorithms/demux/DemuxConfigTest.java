...
class DemuxConfigTest {
	...
	void testBuilderOverrides() {
		DemuxConfig config = DemuxConfig.builder()
				.k(9)
				.useLogQuadratic()
				.excludeEdgeSubWindows()
				.build();
	...
	void testInvalidKThrows() {
		assertThrows(IllegalArgumentException.class,
				() -> new DemuxConfig(6, DemuxConfig.InterpolationMethod.CUBIC_HERMITE));
		assertThrows(IllegalArgumentException.class,
				() -> new DemuxConfig(10, DemuxConfig.InterpolationMethod.CUBIC_HERMITE));
	}
