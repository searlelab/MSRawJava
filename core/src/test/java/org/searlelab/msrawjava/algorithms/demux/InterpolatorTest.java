...
class InterpolatorTest {
	...
	void testCubicHermiteLengthMismatch() {
		...
		assertThrows(IllegalArgumentException.class, () -> interp.interpolate(times, intensities, 1.5f));
	}
	...
	void testLogQuadraticLinearData() {
		...
		assertTrue(midPoint>20.0f&&midPoint<35.0f, "Mid-point should be between 20 and 35, got "+midPoint);
	}
	...
	void testLogQuadraticPeakShape() {
		...
		assertTrue(atShoulder>50.0f&&atShoulder<100.0f, "Shoulder value should be between 50 and 100, got "+atShoulder);
	}
	...
	void testLogQuadraticLengthMismatch() {
		...
		assertThrows(IllegalArgumentException.class, () -> interp.interpolate(times, intensities, 2.0));
	}
