...
class DemuxDesignMatrixTest {
	...
	void testFromCycleAndRowIndex() {
		...
		cycle.add(new org.searlelab.msrawjava.model.FragmentScan("s1", "p1", 1, 500.0, 1.0f, 0, 0.0f, 400.0, 420.0, new double[] {100.0}, new float[] {10.0f},
				null, (byte)0, 400.0, 420.0));
		cycle.add(new org.searlelab.msrawjava.model.FragmentScan("s2", "p2", 2, 510.0, 1.2f, 0, 0.0f, 410.0, 430.0, new double[] {100.0}, new float[] {10.0f},
