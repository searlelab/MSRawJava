...
public final class SpectrumRecord {
	...
	public SpectrumRecord(double[] mz, float[] ims, float[] intensity, int msLevel, int frameIndex, double rtSeconds) {
		this.mz=mz;
		this.ims=ims;
	...
	public String toString() {
		return "SpectrumRecord(msLevel="+msLevel+", frame="+frameIndex+", rt="+rtSeconds+"s, points="+mz.length+")";
	}
}
