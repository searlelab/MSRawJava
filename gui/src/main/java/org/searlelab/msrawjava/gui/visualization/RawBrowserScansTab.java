...
class RawBrowserScansTab extends JPanel {
	...
	private void initUi() {
		...
		JRadioButton xicModeButton=new JRadioButton("XIC", true);
		JRadioButton deltaModeButton=new JRadioButton("delta m/zs:");
		ButtonGroup xicModeGroup=new ButtonGroup();
		xicModeGroup.add(xicModeButton);
		xicModeGroup.add(deltaModeButton);
		xicModeButton.setToolTipText("Plot extracted ion chromatogram intensity.");
		...
		JPanel xicModePanel=new JPanel();
		xicModePanel.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 2, 0));
		xicModePanel.add(xicModeButton);
		xicModePanel.add(new JLabel("|"));
		xicModePanel.add(deltaModeButton);
		xicBar.add(xicModePanel, BorderLayout.WEST);
		...
		xicController.bindControls(xicLabel, xicModeButton, deltaModeButton, xicField, xicToleranceFilter, extractXicButton);
